    ...
    public class ServicioTimbrado : IServicioTimbrado
    {
        ...
        public TimbradoResponse TimbraCfdiQr(string userName, string password, string comprobante)
        {
            ...
            try
            {
                ...
                ServicioTimbrado.Logger.Debug(userName);
               // MembershipUser x = NtLinkLogin.ValidateUser(userName, password);
                var x = NtLinkLogin.ValidateUserPruebas(userName, password);
                ...
                {
                      empres = TimbradoUtils.ValidarUsuario(comp.Emisor.Rfc, x.ID);
                   ...
                   // if (vemp != "OK")
                    if(empres==null)
                    {
                        ...
                        {
                            Valido = false,
                            DescripcionError = "Error al sellar el comprobante: en los datos de la empresa"
                        };
                        return result2;
                    }
                }
                                ...
                                if (nomin12 && erroresNomina == "0")
                                {
                                   ...
                                   if (erroresNomina != "0")
                                    ...
                                    if (timbre != null && timbre.SelloSAT != null && dict.Count == 0)
                                    {
                                        ...
                                        {
                                            if (!TimbradoUtils.GuardaFactura(x.ID, comp.Fecha, comp.Emisor.Rfc, comp.Receptor.Rfc, timbre.UUID, cfdiTimbrado, hash, empres, true, false))
                                            {
                ...
                if (comp.Emisor != null && comp.Emisor.Rfc != null)
                {
                  ...
                  //  string vemp = ValidarUsuario(comp.Emisor.Rfc, x, ref empres);
                   // if (vemp != "OK")
                    if(empres==null)
                    {
                        result = "Error al abrir el comprobante, en los datos de la empresa";
                    }
                }
                else
                {
                ...
                if (pago10)
                    ...
                    if (comprobante.Contains("<ecc12:EstadoDeCuentaCombustible"))
                       ...
                       if (ComerExt && erroresNomina == "0")
                            ...
                            result = TimbradoUtils.TimbraCfdiString(comprobante, empres, x.ID);
        ...
        public string TimbraRetencion(string userName, string password, string comprobante)
        {
            ...
            try
            {
              ...
              //  MembershipUser x = NtLinkLogin.ValidateUser(userName, password);
                ...
                {
                    empres = TimbradoUtils.ValidarUsuario(comp.Emisor.RFCEmisor, x.ID);
                ...
                result = TimbradoUtils.TimbraRetencionString(comprobante, empres, true, true, x.ID);
               ...
               if(empres==null)
                    {
                        ...
                        {
                            Valido = false,
                            DescripcionError ="Error al abrir el comprobante, en los datos de la empresa"
                        };
                        return result2;
                ...
                //--------------------------------------------------
                        ...
                        if (timbre != null && timbre.selloSAT != null && dict.Count == 0)
                        {
                            ...
                            if (ConfigurationManager.AppSettings["EnvioSat"] == "false")
                            {
                                ...
                                if (!TimbradoUtils.GuardaFactura(x.ID, fechaExp, comp.Emisor.RFCEmisor, "", timbre.UUID, cfdiTimbrado, hash, empres, true, true))
                                {
                                    throw new Exception("Error al abrir el comprobante");
                                }
                            }
